...
const ProfileCardComponent = ({
  ...
  const props = {
    ...
    showUserInfo: true,
    enableTilt: true,
    enableMobileTilt: false, // Disabled as requested
    ...
    const handleClick = () => {
      ...
      if (typeof window.DeviceMotionEvent.requestPermission === 'function') {
        window.DeviceMotionEvent
          ...
          .catch(() => {
            // Device motion permission denied - silently handle
          });
      } else {
        window.addEventListener('deviceorientation', deviceOrientationHandler);
      }
          ...
          <div className="pc-content pc-avatar-content">
            <img
              ...
              onError={(e) => {
                ...
                target.src = "/api/placeholder/400/600"; // Fallback to placeholder
                ...
                <div className="pc-user-details">
                  <div className="pc-mini-avatar">
                    <img
                      ...
                      onError={(e) => {
                        const target = e.target;
                        target.src = "/api/placeholder/120/120"; // Fallback to placeholder
                        target.style.opacity = "0.7";
                      }}
                    />
                  </div>
